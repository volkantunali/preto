...
public class PretoAboutBox extends javax.swing.JDialog {

    public PretoAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(preto.PretoApp.class).getContext().getResourceMap(PretoAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(preto.PretoApp.class).getContext().getActionMap(PretoAboutBox.class, this);
